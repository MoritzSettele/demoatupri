                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Atupri Chatbot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Stelle Fragen zu unseren Versicherungsprodukten</h2>
                            </Stack>
                        ) : (
