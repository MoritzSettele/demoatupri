...
import Azure from "../../assets/Atupri_logo.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Customer Support Assistant</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Stelle hier die Fragen der Kund:innen.</h2>
                            </Stack>
                        ) : (
